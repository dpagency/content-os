  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#09090B] text-slate-300 p-6 font-sans">
      <div className="w-full max-w-md bg-[#121214] border border-white/5 rounded-2xl p-8 shadow-xl text-center relative overflow-hidden">
        ...
        <p className="text-sm text-slate-500 mb-8 max-w-xs mx-auto relative">
          Centralize your content operations, manage multiple brands, and generate content with AI.
        </p>
        
        <button
          onClick={signInWithGoogle}
          className="relative w-full h-11 flex items-center justify-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 rounded-lg text-sm font-bold text-white transition-colors"
        >
